...
export const SessionSummary: React.FC<SessionSummaryProps> = ({
  ...
  const efficiency =
    stats.sessionDuration > 0
      ? Math.round((stats.totalWorkTime / stats.sessionDuration) * 100)
      : 0;

  return (
    <div className="session-summary bg-white p-6 rounded-lg shadow-md">
      <h2 className="session-summary__title text-2xl font-bold mb-6 text-center">
        Session Summary
      </h2>
